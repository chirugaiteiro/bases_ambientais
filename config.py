...
BASES_ADMINISTRATIVAS = [
    {"nome": "Municípios MS", "url": "https://www.pinms.ms.gov.br/arcgis/rest/services/SEMADESC/SEMADESC_MAPAS/MapServer/38/query", "colunas_nome": ["MUNICIPIO", "MUNICIPIO (Município)", "Município", "NOME_MUN", "nm_mun"], "coluna_legis": [], "tipo": "poligono"},
    {"nome": "Biomas em MS", "url": "https://www.pinms.ms.gov.br/arcgis/rest/services/IMASUL/lim_biomas_atual/MapServer/0/query", "colunas_nome": ["Bioma", "nm_bioma"], "coluna_legis": ["info_legis"], "tipo": "poligono"}
]
...
BASES_FISCALIZACAO = [
    ...
    {"nome": "Áreas Antropizadas (SICAR/Dinamizada)", "tipo_fonte": "REST", "url": "https://www.pinms.ms.gov.br/arcgis/rest/services/CAR/Insumos/MapServer/1/query", "colunas_nome": ["Class_Name", "CLASS", "OBJECTID"], "tipo": "poligono"},
]
...
URL_DECLIVIDADE_EXPORT = "https://www.pinms.ms.gov.br/arcgis/rest/services/Imagens/mosaico_fusao_declividade_graus/ImageServer/exportImage"
